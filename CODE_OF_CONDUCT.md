...
1. **Correction**: A private, written warning from project maintainers.
2. **Warning**: A warning with consequences for continued behavior.
3. **Temporary Ban**: A temporary ban from any sort of interaction within the project organization for a defined period of time.
4. **Permanent Ban**: A permanent ban from the project organization.
